      ...
      <main className="pt-32 pb-20">
        ...
        <section className="px-6 max-w-[1120px] mx-auto mb-20">
          <FadeIn immediate>
            ...
            <div className="mb-8">
              <Image 
                src="/logos/kommo-partner-dark.svg" 
            ...
            <h1 className="font-serif text-[clamp(36px,5vw,56px)] text-slate-950 font-normal leading-[1.1] mb-6 max-w-3xl">
              Implementación de Kommo para <em className="text-[#5C45D3] not-italic">alta transaccionalidad B2C.</em>
            </h1>
            ...
            {/* BOTONES DE ACCIÓN (CTA) - ACTUALIZADOS A MORADO KOMMO */}
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <a 
                href="#contacto" 
                className="bg-[#5C45D3] text-white px-8 py-3.5 rounded-xl font-sans text-[15px] font-bold shadow-md hover:bg-[#4A37A8] transition-all w-full sm:w-auto text-center"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <ul className="space-y-6">
                <li className="flex gap-4">
                  <Check className="text-[#5C45D3] shrink-0" />
                  <div>
        ...
        {/* SECCIÓN DE CONTACTO CON IFRAME */}
