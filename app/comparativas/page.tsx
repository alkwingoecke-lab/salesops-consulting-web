...
const directory = [
  ...
  { name: "Kommo", desc: "Nativo en WhatsApp, para ventas por chat", active: false },
  { name: "monday", desc: "Plataforma flexible de gestión de trabajo", active: false },
  { name: "Bitrix24", desc: "Todo en uno gratis, muy amplio", active: false },
];
